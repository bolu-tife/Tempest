<%-- 
    Document   : planpassword
    Created on : 28-Dec-2019, 17:19:45
...
<html>
    ...
    <body id="page-top" style="background-image: url(bg-main2.jpg); background-repeat: no-repeat; background-position: center; background-size: cover;" >
        ...
        <div class="container" style="padding: 100px;">
            ...
            <div class="row">
                <div class="col-md-8 order-md-1">
                    <h4 class="mb-3">Create Identity</h4>
                    <form class="needs-validation" novalidate="" action="createplan1.jsp" method="post">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit">Create Plan</button>
                         </div>
                    </form>
                </div>
