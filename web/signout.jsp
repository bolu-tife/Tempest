<%-- 
    Document   : signout
    Created on : 13-Jan-2020, 09:50:04
...
<html>
  ...
  <link href="css/grayscalemin.css" rel="stylesheet">
    ...
    <body id="page-top" style="background-image: url(bg-signup.jpg);">
        
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top" >Tempest</a>
    ...
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase">Tempest</h1>
        <h2 class="text-white-50 mx-auto mt-2 mb-5">Thank you!</h2>
        <a href="index.html" class="btn btn-primary js-scroll-trigger">Get Back</a>
      </div>
    </div>
  </header>
